...
export interface Student {
  ...
  sponsor_name_bd?: string;
  sponsor_personal_number?: string;
  father_name_bd?: string;
  father_dob?: string | Date;
  father_occupation?: string;
  father_phone?: string;
  mother_name_bd?: string;
  mother_occupation?: string;
  passport_issuing_authority?: string;
  nid_issue_date?: string | Date;
  family1_name?: string;
  family1_dob?: string | Date;
  family1_occupation?: string;
  family2_name?: string;
  family2_dob?: string | Date;
  family2_occupation?: string;
  family3_name?: string;
  family3_dob?: string | Date;
  family3_occupation?: string;
