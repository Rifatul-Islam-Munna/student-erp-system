...
const studentSchema = new mongoose.Schema({
    ...
    sponsor_name_bd: { type: String, trim: true },
    sponsor_personal_number: { type: String, trim: true },
    father_name_bd: { type: String, trim: true },
    father_dob: { type: Date },
    father_occupation: { type: String, trim: true },
    father_phone: { type: String, trim: true },
    mother_name_bd: { type: String, trim: true },
    mother_occupation: { type: String, trim: true },
    passport_issuing_authority: { type: String, trim: true },
    nid_issue_date: { type: Date },
    family1_name: { type: String, trim: true },
    family1_dob: { type: Date },
    family1_occupation: { type: String, trim: true },
    family2_name: { type: String, trim: true },
    family2_dob: { type: Date },
    family2_occupation: { type: String, trim: true },
    family3_name: { type: String, trim: true },
    family3_dob: { type: Date },
    family3_occupation: { type: String, trim: true },
