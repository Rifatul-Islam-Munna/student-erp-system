...
const explicitFieldMap = {
    ...
    '{{mother_dob}}': { dbField: 'mother_dob', source: 'field' },
    '{{mother_dob:year}}': { dbField: 'mother_dob', source: 'derived', transform: 'date.year' },
    '{{mother_dob:month}}': { dbField: 'mother_dob', source: 'derived', transform: 'date.month' },
    '{{mother_dob:day}}': { dbField: 'mother_dob', source: 'derived', transform: 'date.day' },
    '{{mother_phone}}': { dbField: 'mother_phone', source: 'field' },
